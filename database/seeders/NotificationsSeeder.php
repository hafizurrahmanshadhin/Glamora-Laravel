        ...
        DB::table('notifications')->insert([
            [
                ...
                'data'            => json_encode([
                    ...
                    'appointment_date' => '2025-02-27T00:00:00.000000Z',
                    'appointment_time' => '9:00 AM',
                ]),
                'read_at'         => '2025-02-01 00:33:18',
                'created_at'      => '2025-01-31 23:48:00',
                'updated_at'      => '2025-02-01 00:33:18',
            ],
            [
                ...
                'data'            => json_encode([
                    ...
                    'user_service_id'  => 12,
                    'service_type'     => 'salon_services',
                    'appointment_date' => '2025-02-28T00:00:00.000000Z',
            ...
            [
                ...
                'data'            => json_encode([
                    ...
                    'user_service_id'  => 3,
                    'service_type'     => 'salon_services',
                    'appointment_date' => '2025-12-31T00:00:00.000000Z',
                    'appointment_time' => '7:00 PM',
                ]),
                'read_at'         => '2025-02-01 00:33:22',
                'created_at'      => '2025-01-31 23:44:26',
                'updated_at'      => '2025-02-01 00:33:22',
            ],
            [
            ...
            [
                ...
                'notifiable_id'   => 2,
                'data'            => json_encode([
                    'message'    => 'I’m Available with Date: 2025-12-31 00:00:00, Time: 7:00 PM, Price: 32.40',
                    'booking_id' => 1,
                ]),
                'read_at'         => '2025-02-01 00:32:43',
                'created_at'      => '2025-01-31 23:46:30',
                'updated_at'      => '2025-02-01 00:32:43',
            ],
            [
                ...
                'notifiable_id'   => 2,
                'data'            => json_encode([
                    'message'    => 'I’m Available with Date: 2025-12-31 00:00:00, Time: 9:00 AM, Price: 240.00',
                    'booking_id' => 2,
                ]),
                'read_at'         => '2025-02-01 00:32:31',
                'created_at'      => '2025-01-31 23:48:25',
                'updated_at'      => '2025-02-01 00:32:31',
            ],
            [
                ...
                'data'            => json_encode([
                    ...
                    'user_service_id'  => 20,
                    'service_type'     => 'mobile_services',
                    'appointment_date' => '2027-12-31T00:00:00.000000Z',
                    'appointment_time' => '7:00 PM',
                ]),
                'read_at'         => null,
