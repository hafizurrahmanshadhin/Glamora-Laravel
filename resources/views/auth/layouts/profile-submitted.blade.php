        ...
        <div class="section-padding-x">
            <div class="submit-review-section-content-wrapper">
                <div class="submit-review-img-area">
                    <img src="{{ asset($profileReviewMessage->image ?? 'frontend/images/submit-review.png') }}"
                        alt="Profile Review Message Image">
                </div>
                <div class="submit-review-text-area">
                    <h1>{{ $profileReviewMessage->title ?? 'Profile Submitted for Review!' }}</h1>
                    <p class="submit-review-text-one">
                        {!! $profileReviewMessage->description ??
                            'Thank you for providing your information! Our team is reviewing your details to ensure everything is in order. You will receive an <span>email</span> notification once your profile has been approved.' !!}
                    </p>
                    <div class="submit-review-text-two-wrapper">
                        ...
                        <div class="info-container" style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <span>
                                {!! $profileReviewMessage->content ??
                                    'This process typically takes 1-2 business days. We appreciate your patience and look forward to having you on board!' !!}
                            </span>
                        </div>
                        </p>
                    </div>
