                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content"
                                            placeholder="Enter any detailed information here...">{{ old('content', $questionnaires->content ?? '') }}</textarea>
                                        @error('content')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" id="addNewBlog">Add New Questionnaires</button>
                        </div>
                        <div class="card-body">
