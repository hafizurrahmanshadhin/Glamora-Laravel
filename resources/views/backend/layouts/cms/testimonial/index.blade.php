...
@section('title', 'Home Page Testimonial Image')
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card auth-image-card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Current Home Page Testimonial Image</h5>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#updateImageForm').on('submit', function(e) {
                ...
                axios.post("{{ route('cms.testimonial.store') }}", formData, {
                    headers: {
