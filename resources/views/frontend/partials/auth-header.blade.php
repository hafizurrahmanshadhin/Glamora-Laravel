                    ...
                    <div class="notification-list">
                        @foreach ($notifications as $notification)
                            @php
                                ...
                                // If the user is a 'client', link to make-payment; otherwise, link to negotiate-request
                                $url =
                                    Auth::user()->role === 'client' && $bookingId
                                        ? route('make-payment')
                                        : route('negotiate-request', ['booking' => $bookingId]);
                            @endphp
                            ...
                            <a href="{{ $url }}" class="item">
                                ...
                                <div class="right">
                                    <div class="item-text">
                                        {{ $notification->data['message'] ?? 'New booking notification' }}
                                        <br>
