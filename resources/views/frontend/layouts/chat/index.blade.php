            ...
            <div id="user-messages" class="user-messages">
                <div class="user-title">
                    ...
                    <div class="d-flex align-item-center gap-2">
                        <svg class="back-to-inbox-btn" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <path d="M19 12H5M5 12L11 18M5 12L11 6" stroke="#121715" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="single-message opposite-message">
                        ...
                        <div class="right-content">
                            ...
                            <div class="user-text">
                                <div class="text">
                                    Hello NCP, <br />
                                    Please give me some time to thoroughly check the item you
                                    are referring to. I need a few minutes to review it
                                ...
                                <div class="time">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <g clip-path="url(#clip0_248_163)">
                                            <path d="M9.25 5.25L3.75 10.75L1 8" stroke="#F8CF2C" stroke-linecap="round"
...
@push('scripts')
    <script>
        ...
        document
            .querySelector(".back-to-inbox-btn")
