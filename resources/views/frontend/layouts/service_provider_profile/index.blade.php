                ...
                <div class="service-profile-provider-content-left">
                    <div class="profile-info">
                        <div class="tm-profile-info-img-area">
                            <img src="{{ asset('frontend/images/service-provider-profile.jpg') }}" alt="">
                        </div>
                        <div class="profile-details-wrapper">
                            <div class="profile-name-place-rating-wrapper">
                                ...
                                <div class="service-provider-rating"><span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                                            <path
                            ...
                            <p class="profile-details-para">
                                With over 10 years of experience in bridal makeup and hairstyling, Sophia Green is
                                dedicated to enhancing your natural beauty on your special day. Whether it’s a timeless
                                classic look or a more contemporary style, Sophia tailors each service to meet your
                                individual needs, ensuring a flawless finish.
                            </p>
                        </div>
                    </div>

                    <div class="tm-services">
                        <h3>Services By Sophia Grace</h3>
                        <div class="service-grid">
                            <a href="#" class="service-item">
                                <div class="service-area-image-area">
                                    <img src="{{ asset('frontend/images/service-image.jpg') }}" alt="Bridal Makeup">
                                    <p class="best-selling">Best Selling</p>
                                </div>
                                <div class="tm-service-name-price-wrapper">
                                    <h4>Bridal Makeup</h4>
                                    <h5 class="tm-price">200$</h5>
                                </div>
                                <p class="service-type-description">
                                    Bridal Makeup, Event Makeup, Natural Daytime Makeup
                                </p>
                            </a>
                            <a href="#" class="service-item">
                                <div class="service-area-image-area">
                        ...
                        <div class="gallery-grid">
                            <a href="#" class="gallery-item">
                                <div class="gallery-item-img-area">
                                    <img src="{{ asset('frontend/images/service-image-2.jpg') }}" alt="Bridal Makeup">
                                </div>
                            ...
                            <!-- Repeat more gallery items as needed -->
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tax-profile-single-comment-header">
                            <div class="tax-profile-single-comment-author">
                                ...
                                <div class="tax-profile-single-comment-author-name">
                                    <p>Sakib Mo</p>
                                    <span><svg xmlns="http://www.w3.org/2000/svg" width="78" height="14"
