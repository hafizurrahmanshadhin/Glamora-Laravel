<div class="search-container ">
    <div class="item location" style="position: relative;">
        ...
        <input id="location-input" placeholder="Search" type="text" value="{{ request('location') }}" autocomplete="off"
            style="width:100%;">
                ...
                <div class="select-service-dropdown-options d-flex flex-column gap-3 ">
                    <div class="item d-flex flex-column gap-2">
                        ...
                        <select id="service-selector" class="form-select" aria-label="Default select example">
                            ...
                            <option value="special-events">Glam/Hairstyling for Special Events/Party</option>
                            ...
                            <option value="themed-events">Character & Themed Events (Costume Party, Dress Ups)
                            </option>
                        </select>
                    </div>
